...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home.php" class="logo"><i class="fas fa-house"></i>Rent Estate Portal</a>

         <ul>
            <li><a href="post_property.php"> + Create New Property Listing<i class="fas fa-paper-plane"></i></a></li>
         </ul>
      </section>
   </nav>
   ...
   <nav class="navbar nav-2">
      <section class="flex">
         ...
         <ul>
            <li><a href="saved.php">Favourite <i class="far fa-heart"></i></a></li>

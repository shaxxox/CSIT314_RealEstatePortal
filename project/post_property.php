...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="enter name/ location..." class="input">
      </div>
      <div class="flex">
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="how many sqft?" class="input">
         </div>
         <div class="box">
            <p>Remaining Lease/ Property Age <span>*</span></p>
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="how old is property/ remaining lease?" class="input">
         </div>
         <div class="box">
            <p>Floor No. (For Condominum/ HDB) <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="floor no..." class="input">
         </div>
         <div class="box">
            <p>No. of levels (For Landed Property) <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="no. of levels..." class="input">
         </div>
         <div class="box">
            <p>Loan<span>*</span></p>
      ...
      <div class="checkbox">
         <div class="box">
            ...
            <p><input type="checkbox" name="play_ground" value="yes" />Playground</p>
